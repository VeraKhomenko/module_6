...
const getSortedUniqueSkills = array =>
  array
    .reduce((totalSkills, { skills }) => {
      return totalSkills.concat(skills);
    }, [])
    .filter((skill, idx, skills) => skills.indexOf(skill) === idx)
    .sort();
// (totalSkills[skills] = totalSkills.hasOwnProperty(skills)
//   ? totalSkills[skills] + 1
//   : 1),

// const getSortedUniqueSkills = array =>
//   array.reduce(function (totalSkills, skills) {
//     totalSkills.push(...skills);
//     return totalSkills;
//     // console.log(totalSkills);
//     // console.log(skills);
//     // if (totalSkills.hasOwnProperty(skills)) {
...
//       {
//         ...totalSkills,
//         [skills]: totalSkills.hasOwnProperty(skills)
//           ? totalSkills[skills] + 1
//           : 1,
//       },
//       {}
